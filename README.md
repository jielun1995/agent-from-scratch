...
| 课程 | 主题 | 核心问题 | 状态 |
|------|------|---------|------|
| [01](./01-react-loop/) | **ReAct 循环** | Agent 到底是什么？ | 🚧 进行中 |
| [02](./02-plan-execute/) | **Plan-Execute 多步骤任务** | 如何处理复杂任务？ | ⬜ 待开始 |
| [03](./03-evaluation/) | **评估体系** | 如何知道 Agent 做得好不好？ | ⬜ 待开始 |
| [04](./04-context-engineering/) | **上下文工程** | 如何让 Agent 跑得又便宜又好？ | ⬜ 待开始 |
...
**如果你是我（未来的自己）**：
- 每周日做一次复盘，更新 `changelog.md`
- 30 天后回看 notes，在原文档底部加"30 天后的我补充"
- 发现新洞察就写进 `insights/`

**如果你是别人**：
- 这是学习笔记，不是教程。请把它当作"一个人的思考过程"来读
- 代码都跑得通，但故意省略了很多生产级特性（错误处理、可观测性等）
- 欢迎提 Issue 讨论，但请理解这是个人学习记录
